...
test('les libelles poses reprennent le texte deja visible a l ecran', () => {
  ...
  assert.match(HTML, /id="tgl18h"[^>]*aria-label="Filtre 36h automatique"/);
  ...
  for (const t of ['Filtre 36h automatique', 'Actualisation automatique (15 min)', 'Afficher le niveau de fiabilite']) {
